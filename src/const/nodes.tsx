  ...
  llm: [
    {
      ...
      type: 'llm',
      name: 'OpenAI',
      desc: 'Powerful general-purpose language model known for its versatility, creativity, and strong reasoning capabilities.',
      icon: 'openai',
    },
    {
      id: 'anthropic',
      type: 'llm',
      name: 'Anthropic',
      desc: 'Safety-focused language model designed for helpfulness, honesty, and harmlessness in human-AI interaction.',
      icon: 'anthropic',
    },
    {
      id: 'mistral',
      type: 'llm',
      name: 'Mistral',
      desc: 'Lightweight, open-weight model optimized for performance, transparency, and rapid deployment.',
      icon: 'mistral',
    },
    {
      id: 'meta',
      type: 'llm',
      name: 'Meta',
      desc: 'Cutting-edge open-source model (LLaMA series) built for research, scalability, and modularity.',
      icon: 'meta',
    },
  ],
};
